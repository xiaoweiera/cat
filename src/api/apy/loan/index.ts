...
import { loanPoolParam,loanChart,tokenLendingPoolParam} from '~/logic/apy2/interface'
enum API {
...
//top10图表
export const lending_best10 =(param:loanChart)=> request({url:API.lending_best10, params:param, method: 'get'})
//token借贷列表
