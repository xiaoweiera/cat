...
onMounted(() => {
  ...
  chainWalletStatus.value = getTimeStatus(chainWallet)
})
</script>
<template>
  ...
  <div>
    <div class="md:-m-3 md:flex md:flex-wrap">
      ...
      >
        <GrowthpadProject
            :value="
            chainWalletStatus === 'wait'
              ? chainWallet.dashboard.begin
              : chainWallet.dashboard.end
          "
