...
//@ts-ignore
const props=defineProps({ project_url:String, tokenName:String, id:Number | String })
...
<template>
  <div class="text-kd12px16px  text-global-primary  text-right font-medium font-kdFang">
    <a  @click="hmt.click('底部榜单点击去挖矿','mining_list_deposit')"  v-router.blank="project_url"  class="hand block">{{I18n.apyIndex.miningFarm}}</a>
