  ...
  <div class="font-kdFang">
    <div>
      ...
      <div class="flex items-center">
        <a class="text-global-primary flex  mt-2.5 items-center font-kdExp hand" :href="data.project_url" target="_blank">
        ...
        <IconFont size="16" class="text-global-highTitle text-opacity-10 px-2 mt-2.5  " type="icon-gang"/>
        <a class="text-global-primary flex  mt-2.5 items-center font-kdExp hand" :href="data.project_url" target="_blank">
          <IconFont size="16" type="icon-jiaocheng"/>
          <span  target="_blank" class="ml-1 text-kd14px18px font-medium hand">{{I18n.apyIndex.projectTutorial}}</span>
        </a>
      </div>

      <!--  数字-->
      <div class="tbBorder py-3 mt-3">
        <div class=" min-h-11 flex font-kdFang ">
      ...
      <div class="py-3 min-h-11 bottomBorder">
        <div class="min-h-11 flex font-kdFang ">
          <div class="flex-1 rightBorder  ">
      ...
      <!-- 项目描述-->
      <div class="font-kdFang text-kd14px22px py-3 ">
