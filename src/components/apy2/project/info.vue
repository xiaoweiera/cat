...
<template>
  <div class="font-kdFang">
    <div class="hidden" v-if="data.name">
      ...
      <UiWechatShare :title="I18n.template(I18n.apyIndex.pageProject.title, { project: data.name })" :content="I18n.template(I18n.apyIndex.pageProject.content,{des:data.projectDes})"/>
