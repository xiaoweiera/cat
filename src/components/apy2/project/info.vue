...
<template>
  <div class="font-kdFang">
    <div class="hidden" v-if="data.name">
      ...
      <UiWechatShare :title="I18n.template(I18n.apyIndex.pageProject.title, { project: data.name })" :content="data.project_description?data.project_description:I18n.apyIndex.pageProject.content"/>
