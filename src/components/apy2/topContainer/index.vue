...
<!--    <div class="border-1  border-global-numRed h-full flex-1">e</div>-->
    ...
    <Apy2TopContainerList   :origin='origin' :dialogType='dialogType'  :class="(props.header )?'md:w-90 md:min-w-90':'md:w-87 md:min-w-87'" :type="props.type" :page='props.page' :header="props.header" :project="props.project" :token="props.token" :title="title" :paramData="props.paramData" :tokenItem="token" class=" min-h-76 h-full md:ml-6 order-0 md:order-1 md:mb-0 mb-3" />
  </div>
