...
<!--      <template #title>-->
<!--        <div class="mt-1 hand">{{I18n.apyIndex.calculator}}</div>-->
<!--      </template>-->
<!--      <template #content>-->
<!--        <Apy2Calculator :chain="data.chain"  :lendCoin="data.lending_symbol" :loanCoin="data.symbol_alias" :project_id="data.project_id" />-->
<!--      </template>-->
<!--    </UiDialogBase>-->
  </div>
</template>
