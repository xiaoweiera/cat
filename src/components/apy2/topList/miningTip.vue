...
<template>
  <div class="font-kdFang ">
    <div v-if="data.chain" class="flex items-center">
      <span class="labelName">公链类型</span>
    ...
    <div v-if="data.project_category" class="flex mt-1.5 items-center">
      <span class="labelName">矿池类型</span>
    ...
    <div v-if="data.strategy_tags" class="flex mt-1.5 items-center">
      <span class="labelName">矿池标签</span>
    ...
    <div v-if="data.lever" class="flex mt-1.5 items-center">
      <span class="labelName">杠杆倍数</span>
    ...
    <div v-if="data.single_apy_detail || data.compound_detail" class="flex flex-col mt-1.5 relative">
      <div class="labelName whitespace-nowrap">APY构成</div>
      <div v-if="data.single_apy_detail" class="ml-0.7 mt-1.3 relative"><div class="roundTip">.</div><span class="labelName ml-3.6">单利收益</span><span class="money">{{data.single_apy_detail}}</span></div>
      <div v-if="data.compound_detail" class="ml-0.7 mt-1.3 relative"><div class="roundTip">.</div><span class="labelName ml-3.6">复利收益</span><span class="money">{{data.compound_detail}}</span></div>
    </div>
    <div v-if="data.quota_remain || data.quota_remain_percent" class="flex mt-1.5 items-center">
      <span class="labelName">剩余额度</span>
