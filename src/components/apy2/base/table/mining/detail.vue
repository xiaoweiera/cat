...
.apy-detail {
  ...
  .label {
    @apply text-xs text-global-highTitle text-opacity-45;
  }
  .dot {
    @apply relative pl-5.5;
    &:before {
      @apply absolute left-2.5 top-1/2;
      @apply w-1.5 h-1.5 inline-block;
      @apply bg-global-highTitle bg-opacity-45;
      content: "";
      border-radius: 50%;
