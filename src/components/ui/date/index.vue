...
<!--provide('ElLocaleInjection', {locale, t, lang: 'en' })-->
...
<!--&lt;!&ndash;              <el-date-picker class="ui-date-picker cursor-pointer" :disabledDate="disabledDate(timeEnd)" :unlink-panels="true" v-model="customTime" @change="onChangeCustomTime(item, $event)" format="YYYY-MM-DD" size="mini" type="daterange" range-separator="–" :start-placeholder="I18n.apy.times.begin" :end-placeholder="I18n.apy.times.end">&ndash;&gt;-->
