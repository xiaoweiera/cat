...
<!--    pc-->
    <div class="xshidden">
      <div class="flex md:flex-row flex-col  mt-5 md:items-center">
...
<!--    mobile-->
    <div class="mdhidden">
      <div>
        <div class="flex md:flex-row flex-col relative   md:items-center">
          <div class="flex items-center " @click="changeShow">
          ...
          <div v-show="show"  class=" optionModel">
            <div v-for="(item,i) in realOptions">
