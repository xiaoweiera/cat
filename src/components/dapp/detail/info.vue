...
<template>
  <div class="flex flex-wrap text-14-18 md:pt-3">
    ...
    <div class="wrap-item order-4 md:order-5">
      <div class="flex items-center">
        <span class="pr-3 min-w-17 inline-block text-global-highTitle text-opacity-45">{{ I18n.dapp.info.chain }}</span>
    ...
    <div class="wrap-item order-6">
      <span class="pr-3 min-w-17 inline-block text-global-highTitle text-opacity-45">{{ I18n.dapp.info.state }}</span>
