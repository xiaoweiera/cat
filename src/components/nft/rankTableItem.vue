...
<template>
  <a  v-if='headerData' v-router.blank='item.external_url'  class="px-3 py-1.5 item  relative hand relative   bg-global-white mt-1.5 flex items-center rounded-kd6px" :style="`--wv:${bgWidth};z-index:${zIndex+100}`">
