...
export const dappHeaderMobile = [
  ...
  { key:'chains',name: I18n.dapp.rank.table.chain, width: 'w-33', class: ' justify-center i8n-font-Barlow ', sort: false },
...
export const nftHeaderMobile = [
  { key:'order',name: I18n.nft.rank.table.order, width: 'w-10.5 md:min-w-7 ', class: ' i8n-font-Barlow ', sort: false },
  { key:'name',name: I18n.nft.rank.table.name, width: 'w-66', class: ' justify-center i8n-font-Barlow ', sort: false },
  { key:'volume',name: 'Volume', width: 'w-33', class: ' justify-end i8n-font-Barlow ', sort: true },
  { key:'h24_volume_change_percent',name: '24H', width: 'w-33', class: ' justify-end i8n-font-Barlow ', sort: true },
  { key:'d7_volume_change_percent',name: '7D', width: 'w-33', class: ' justify-end i8n-font-Barlow ', sort: true },
  { key:'owners',name: 'Owners', width: 'w-33', class: ' justify-end  i8n-font-Barlow ', sort: true },
  { key:'assets',name: 'Assets', width: 'w-33', class: ' justify-end  i8n-font-Barlow ', sort: true },
  { key:'floor_price',name: 'Floor Price', width: 'w-33', class: ' justify-end  i8n-font-Barlow ', sort: true },
  // { key:'avg_price',name: 'Avg Price', width: '', class: ' justify-end  i8n-font-Barlow  ', sort: true },
  { key:'mcap',name: 'MCap', width: 'w-33', class: ' justify-end i8n-font-Barlow  ', sort: true },
  { key:'categories',name: I18n.nft.rank.table.type, width: 'w-33 ', class: ' justify-center i8n-font-Barlow  ', sort: false },
  // { key:'avg_price',name: 'Avg Price', width: '', class: ' justify-end  i8n-font-Barlow ', sort: true },
]
