...
export const dappHeader = [
  ...
  { key:'name',name: I18n.dapp.rank.table.name, width: 'w-45', class: ' i8n-font-Barlow', sort: false },
...
export const dappHeaderMobile = [
  { key:'order',name: I18n.dapp.rank.table.order, width: 'w-10.5 ', class: ' i8n-font-Barlow', sort: false },
  { key:'name',name: I18n.dapp.rank.table.name, width: 'w-53', class: ' i8n-font-Barlow', sort: false },
...
export const nftHeader = [
  ...
  { key:'name',name: I18n.nft.rank.table.name, width: 'w-57', class: ' justify-center i8n-font-Barlow', sort: false },
